...
helm upgrade -i isovalent-openshift-console-plugin \
  oci://ghcr.io/christianh814/charts/isovalent-openshift-console-plugin --version 0.1.22 \
...
| --- | --- | --- |
| `plugin.image` | `quay.io/christianh814/isovalent-openshift-console-plugin:v0.0.22` | Plugin container image. |
